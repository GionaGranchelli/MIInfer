...
## Corpus Check
- 270 files · ~236,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4289 nodes · 6536 edges · 342 communities (315 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca51585c`
...
### Community 9 - "GemvKernelResources"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (48): AttentionKernel, Function, capture(), capture_qwen3_head_norm(), copy_to_host(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, size_t (+40 more)
...
Cohesion: 0.09
Nodes (44): argmax(), build_json(), ostream, size_t, string, timespec, uint32_t, vector (+36 more)
...
### Community 299 - "Q8_1Block"
Cohesion: 0.16
Nodes (13): Buffer, Q8_1Block, d, qs, s, allocate(), uint32_t, project() (+5 more)
...
Cohesion: 0.09
Nodes (11): string, RocblasGemmHandle, opaque, vector, upload, main(), string, main() (+3 more)
...
## Knowledge Gaps
- **2488 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2483 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `Q8_1Block`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `KeyPathCapture`, `UpdateProvenance`, `size_t`, `LayerPathCapture`, `OutputProjectionPathCapture`, `Qwen35Config`, `GgufFile`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `Qwen3Config`, `qwen3_decode_sequence_gpu_test.cpp`, `model_plan.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
