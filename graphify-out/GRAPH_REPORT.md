...
## Corpus Check
- 279 files · ~242,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4397 nodes · 6673 edges · 352 communities (325 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `428ed950`
...
## Communities (352 total, 27 thin omitted)
...
Cohesion: 0.03
Nodes (66): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+58 more)
...
### Community 289 - "qwen3_decode_profile.cpp"
Cohesion: 0.17
...
### Community 345 - "Checkpoint"
Cohesion: 0.40
Nodes (5): Checkpoint, file, miinfer, name, tolerance

### Community 346 - "GatePathCapture"
Cohesion: 0.29
...
## Knowledge Gaps
- **2567 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2562 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `vector`, `m6a14_qwen35_state_audit.cpp`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `run_ladder`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `size_t`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `.get`, `LayerPathCapture`, `RecurrentOperands`, `Qwen35Config`, `GgufFile`, `GatePathCapture`, `FullAttentionLayer`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_decode_profile.cpp`, `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `model_plan.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `Qwen3LayerWeights`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
