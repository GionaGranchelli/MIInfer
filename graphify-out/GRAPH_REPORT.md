...
## Corpus Check
- 271 files · ~237,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4300 nodes · 6546 edges · 341 communities (313 shown, 28 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2d5f670`
...
## Communities (341 total, 28 thin omitted)
...
Cohesion: 0.03
Nodes (64): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+56 more)
...
Cohesion: 0.14
Nodes (14): size_t, T, vector, DeviceBuffer, data_, main(), recurrent_inputs(), upload() (+6 more)

### Community 274 - "uint32_t"
Cohesion: 0.26
Nodes (9): Buffer, string, uint32_t, project(), project_q4_q8_1(), project_q4_q8_1_prequantized(), project_q5_q8_1(), RecurrentTrace (+1 more)
...
Cohesion: 0.14
Nodes (22): size_t, Qwen3GpuDecodeCache, caches_, prepare, workspace_, Qwen3Layer0GpuKvCache, keys_, snapshot_keys (+14 more)
...
## Knowledge Gaps
- **2497 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2492 more)
...
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a14_qwen35_state_audit.cpp`, `qwen3_gpu_primitives.hpp`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `path_`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `size_t`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `KeyPathCapture`, `LayerPathCapture`, `uint32_t`, `UpdateProvenance`, `RecurrentOperands`, `Qwen35Config`, `vector`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `model_plan.cpp`, `Qwen3GpuPlan`, `qwen3_decode_sequence_gpu_test.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `Qwen3LayerWeights`, `Qwen3TensorView`, `gguf.cpp`, `vector`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
