...
## Corpus Check
- 304 files · ~252,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4637 nodes · 6888 edges · 372 communities (345 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7e978cb1`
...
## Communities (372 total, 27 thin omitted)
...
Cohesion: 0.03
Nodes (71): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+63 more)
...
Cohesion: 0.16
Nodes (17): Buffer, int16_t, Q8KDeviceBlock, bsums, d, qs, size_t, string (+9 more)
...
Cohesion: 0.13
Nodes (48): tensor, run_sequence(), uint32_t, run_ladder(), main(), check_values(), span, main() (+40 more)
...
### Community 245 - "array"
Cohesion: 0.14
Nodes (12): array, main(), argmax(), size_t, span, is_full_attention_layer(), argmax(), size_t (+4 more)
...
Cohesion: 0.11
Nodes (34): AttentionKernel, capture(), capture_qwen3_head_norm(), copy_to_host(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, T, vector (+26 more)
...
### Community 320 - "path_"
Cohesion: 0.21
Nodes (11): path_, check_device(), Metrics, size_t, T, uint32_t, device_error(), DeviceBuffer (+3 more)
...
### Community 359 - "m6a17_qwen35_composition_ladder.cpp"
Cohesion: 0.39
...
## Knowledge Gaps
- **2757 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2752 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `size_t`, `GatePathCapture`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `LayerPathCapture`, `.get`, `RecurrentOperands`, `Qwen35Config`, `vector`, `FullAttentionLayer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `path_`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `run_combined`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `qwen3_inference_bench.cpp`, `Qwen3GpuPlan`, `Qwen3Config`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `qwen3_decode_sequence_gpu_test.cpp`, `vector`, `model_plan.cpp`, `gguf.cpp`, `qwen3_layer35_external_test.cpp`?**
