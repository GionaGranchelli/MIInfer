...
## Corpus Check
- 428 files · ~346,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5994 nodes · 8407 edges · 508 communities (453 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ecdb8abe`
...
## Communities (508 total, 55 thin omitted)
...
### Community 33 - "Qwen3GpuDecodeCache"
Cohesion: 0.17
Nodes (16): unique_ptr, Qwen3GpuDecodeCache, caches_, prepare, reset, workspace_, reset, argmax() (+8 more)
...
### Community 129 - "span"
Cohesion: 0.10
Nodes (23): cosine_similarity(), detailed_compare(), detailed_device_error(), DetailedError, max_abs, mean_abs, reference_rms, relative_rms (+15 more)
...
### Community 167 - "path_"
Cohesion: 0.15
Nodes (29): path_, argmax(), compare(), compare_checkpoint(), size_t, vector, fp16_round_trip(), main() (+21 more)
...
### Community 387 - "qwen3_swiglu_q8_bench.cpp"
Cohesion: 0.39
...
### Community 400 - "execute_qwen3_decode_gpu_fast_impl"
Cohesion: 0.23
Nodes (13): Qwen3ForwardTrace, embedding, final_norm, layer_outputs, logits, uint32_t, execute_qwen3_decode_gpu(), execute_qwen3_decode_gpu_fast() (+5 more)
...
## Knowledge Gaps
- **3638 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+3633 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `span`, `OutputProjectionPathCapture`, `Qwen35RuntimeEngine`, `Qwen35Model`, `LayerPathCapture`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `.run`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `m6a15_qwen35_hybrid_block_audit.cpp`, `m6a3_qwen35_layer.cpp`, `vector`, `run_ladder`, `path_`, `validate_position`, `Qwen35Model::load`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Qwen35Model`, `recurrent_block`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `span`, `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `Qwen3Layer0GpuKvCache`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a10_qwen35_q4k_projection.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `span`, `m6a9_qwen35_lm_head.cpp`, `m6a263_qwen35_recurrent_contract.cpp`, `run_ladder`, `validate_position`, `GgufFile`, `recurrent_block`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `.run`, `require_match`, `qwen3_layer6_external_test.cpp`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `m6a3_qwen35_layer.cpp`, `m6a12_qwen35_attention_projections.cpp`, `qwen35_gpu_pipeline.hpp`, `model_loader_test.cpp`, `qwen3_decode_sequence_gpu_test.cpp`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`?**
