...
## Corpus Check
- 303 files · ~251,974 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4628 nodes · 6880 edges · 374 communities (347 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `179f458c`
...
## Communities (374 total, 27 thin omitted)
...
### Community 245 - "array"
Cohesion: 0.12
Nodes (32): tensor, array, argmax(), size_t, span, uint32_t, is_boundary(), is_full_attention_layer() (+24 more)
...
### Community 355 - "fp16_gemv_reference.cpp"
Cohesion: 0.47
...
## Knowledge Gaps
- **2750 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2745 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `KeyPathCapture`, `uint32_t`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `OutputProjectionPathCapture`, `size_t`, `LayerPathCapture`, `Qwen35Config`, `GgufFile`, `FullAttentionLayer`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `vector`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `run_combined`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `qwen3_decode_profile.cpp`, `qwen3_inference_bench.cpp`, `Qwen3GpuPlan`, `Qwen3Config`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `model_plan.cpp`, `qwen3_layer35_external_test.cpp`?**
