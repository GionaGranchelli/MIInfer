...
## Corpus Check
- 293 files · ~248,202 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4536 nodes · 6798 edges · 362 communities (335 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0bed713c`
...
## Communities (362 total, 27 thin omitted)
...
### Community 166 - "Qwen3LayerWeights"
Cohesion: 0.17
...
### Community 274 - "qwen3_gpu_layer.cpp"
Cohesion: 0.12
...
### Community 337 - "fp16_gemv_reference.cpp"
Cohesion: 0.47
...
## Knowledge Gaps
- **2678 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2673 more)
...
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `array`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_decode_profile.cpp`, `qwen3_fast_decode_bench.cpp`, `Qwen3LayerWeights`, `Qwen3GpuDecodeCache`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `vector`, `model_plan.cpp`, `qwen3_layer35_external_test.cpp`?**
