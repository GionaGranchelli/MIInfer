...
## Corpus Check
- 759 files · ~830,637 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8703 nodes · 11682 edges · 703 communities (643 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 351 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cae69532`
...
## Communities (703 total, 60 thin omitted)
...
Cohesion: 0.17
Nodes (4): GenerateStats, path, span, uint32_t
...
Cohesion: 0.09
Nodes (7): b64_composition_enabled(), GpuLayerRef, attention, recurrent, uint32_t, run_hybrid_block(), run_prefix()
...
Cohesion: 0.10
Nodes (40): ostream, Q8_1Block, string, vector, DeviceShapeData, device_input_fp16, device_input_q8, device_output (+32 more)
...
Cohesion: 0.08
Nodes (39): set, argmax(), size_t, string, uint32_t, vector, main(), parse_count() (+31 more)
...
Cohesion: 0.05
Nodes (31): DecodeLayerCapture, inputs, outputs, DeviceBytes, bytes_, data_, download(), download_bytes() (+23 more)
...
Cohesion: 0.12
Nodes (24): GenerateOptions, function, size_t, count, opt_prefill_checkpoint_, RuntimeGenerateOptions, max_new_tokens, on_first_token (+16 more)
...
Cohesion: 0.06
Nodes (65): pack_mx_q4k_repacked_tensor(), pack_q4k_mmq_tensor(), main(), allocate(), ByteMismatch, count, first, combined_attn_qk_enabled() (+57 more)
...
### Community 665 - "OutputProjectionPathCapture"
Cohesion: 0.25
...
### Community 697 - "qwen3_primitives_test.cpp"
Cohesion: 0.43
Nodes (7): close_enough(), T, vector, device_copy(), gpu_tests(), host_tests(), main()

### Community 698 - "KeyPathCapture"
Cohesion: 0.33
...
### Community 702 - "StepResult"
Cohesion: 0.67
Nodes (3): StepResult, latency_ms, token

## Knowledge Gaps
- **5524 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+5519 more)
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M26CDecodeResult`, `uint32_t`, `WidePrefillWorkspace`, `size_t`, `RemainderSchedulerCounters`, `uint32_t`, `Qwen35Model`, `qwen3_tokenizer.cpp`, `RecurrentLayer`, `FullAttentionLayer`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `qwen35_gpu_pipeline.hpp`, `PrefillProfile`, `SessionCheckpoint`, `StepTransferMetrics`, `StepResult`, `m12_gdn_chunk_bench.cpp`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `uint32_t`, `StageProfile`, `size_t`, `qwen3_gpu_primitives.hpp`, `Qwen35Model`, `Qwen35RuntimeEngine`, `M23ProfileCounters`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `uint32_t`, `StageProfile`, `qwen3_gpu_primitives.hpp`, `Qwen35Model`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `GatePathCapture`, `M23ProfileCounters`, `miinfer_cli.cpp`, `LayerPathCapture`, `KeyPathCapture`, `OutputProjectionPathCapture`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`, `UpdateProvenance`, `m12_gdn_chunk_bench.cpp`?**
