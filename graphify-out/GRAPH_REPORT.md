...
## Corpus Check
- 445 files · ~353,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6187 nodes · 8599 edges · 526 communities (470 shown, 56 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5bf738d9`
...
## Communities (526 total, 56 thin omitted)
...
### Community 33 - "qwen3_generate.cpp"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (48): size_t, string, vector, escape(), main(), median(), Options, bytes (+40 more)
...
Cohesion: 0.11
Nodes (30): capture_qwen3_head_norm(), Function, Q8_1Block, Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, Qwen3ProfileCategory, launch_projection(), profile_copy_call() (+22 more)
...
### Community 186 - "Qwen3GpuProfileEvent"
Cohesion: 0.08
Nodes (23): hipEvent_t, Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, Qwen3ProfileCategory, vector, Qwen3FfnProbeTrace, ffn_output, gate (+15 more)
...
### Community 275 - "Qwen3ForwardTrace"
Cohesion: 0.13
...
### Community 293 - "qwen3_layer_gpu_impl"
Cohesion: 0.15
Nodes (20): AttentionKernel, size_t, Qwen3Layer0GpuKvCache, append, keys_, reset, values_, uint32_t (+12 more)
...
### Community 404 - "5. Runtime Layers"
Cohesion: 0.29
...
### Community 436 - "array"
Cohesion: 0.14
Nodes (20): array, array, kChannels, size_t, span, vector, full_block(), main() (+12 more)
...
### Community 521 - "GemvKernelResources"
Cohesion: 0.33
...
## Knowledge Gaps
- **3789 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+3784 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `main`, `Qwen35Model`, `LayerPathCapture`, `OutputProjectionPathCapture`, `Qwen35RuntimeEngine`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `.run`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a3_qwen35_layer.cpp`, `Qwen35Model`, `path_`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `run_ladder`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `tensor`, `array`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`, `Qwen35Model::load`, `vector`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `main`, `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `LayerPathCapture`, `run_sequence`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a10_qwen35_q4k_projection.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `Qwen3Layer0KvCache`, `m6a9_qwen35_lm_head.cpp`, `m6a263_qwen35_recurrent_contract.cpp`, `validate_position`, `qwen3_decode_sequence_gpu_test.cpp`, `model_loader_test.cpp`, `GgufFile`, `array`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `.run`, `require_match`, `metrics`, `m6a14_qwen35_state_audit.cpp`, `tensor`, `m6a11_qwen35_attention_prefix.cpp`, `m6a3_qwen35_layer.cpp`, `m6a12_qwen35_attention_projections.cpp`, `qwen35_gpu_pipeline.hpp`, `run_ladder`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _3789 weakly-connected nodes found - possible documentation gaps or missing edges._
