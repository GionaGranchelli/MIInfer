...
## Corpus Check
- 301 files · ~251,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4610 nodes · 6864 edges · 370 communities (343 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afae221e`
...
1. `RecurrentLayer` - 99 edges
2. `path_` - 78 edges
3. `FullAttentionLayer` - 61 edges
...
## Communities (370 total, 27 thin omitted)
...
### Community 9 - "qwen3_decode_profile.cpp"
Cohesion: 0.17
...
### Community 40 - "Q8_1Block"
Cohesion: 0.16
Nodes (14): Q8_1Block, d, qs, s, uint32_t, GpuLayerRef, attention, recurrent (+6 more)
...
Cohesion: 0.03
Nodes (70): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+62 more)

### Community 122 - "Qwen3GpuPlan"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (20): string, GemvShape, id, k, m, projection, RocblasGemmHandle, opaque (+12 more)
...
### Community 168 - ".get"
Cohesion: 0.24
Nodes (4): Buffer, allocate(), project_q6_q8_k_dot4(), upload_tensor()
...
Cohesion: 0.04
Nodes (50): array, hipEvent_t, FullAttentionLayer, attention, batch_head_rms, d_attn_norm, d_ffn_down, d_ffn_gate (+42 more)
...
Cohesion: 0.13
Nodes (29): AttentionKernel, Function, capture_qwen3_head_norm(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, launch_projection(), profile_copy_call(), profile_gpu_call() (+21 more)

### Community 271 - "m6a21_qwen35_gpu_hybrid_block.cpp"
Cohesion: 0.11
Nodes (36): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), byte, GgufTensorType, initializer_list (+28 more)
...
Cohesion: 0.13
Nodes (19): size_t, Qwen3Layer0GpuKvCache, append, keys_, reset, snapshot_keys, snapshot_values, values_ (+11 more)
...
### Community 322 - "Qwen3ForwardTrace"
Cohesion: 0.14
...
### Community 337 - "Qwen3GpuDecodeCache"
Cohesion: 0.13
Nodes (15): vector, Qwen3FfnProbeTrace, ffn_output, gate, layer_output, swiglu, up, Qwen3GpuDecodeCache (+7 more)
...
### Community 343 - ".run"
Cohesion: 0.23
Nodes (9): vector, download(), RecurrentOperands, beta, decay, key, previous, query (+1 more)
...
## Knowledge Gaps
- **2736 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2731 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `LayerPathCapture`, `Q8_1Block`, `.get`, `GatePathCapture`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `KeyPathCapture`, `OutputProjectionPathCapture`, `size_t`, `UpdateProvenance`, `.run`, `Qwen35Config`, `GgufFile`, `FullAttentionLayer`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `vector`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `run_combined`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `run_ladder`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `qwen3_decode_profile.cpp`, `qwen3_inference_bench.cpp`, `Qwen3LayerWeights`, `model_plan.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `Qwen3GpuPlan`, `qwen3_layer35_external_test.cpp`?**
