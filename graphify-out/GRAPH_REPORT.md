...
## Corpus Check
- 424 files · ~345,596 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5957 nodes · 8374 edges · 501 communities (446 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0c195d9`
...
## Communities (501 total, 55 thin omitted)
...
Cohesion: 0.12
Nodes (38): GgufTensor, byte_size, data, dimensions, name, offset, type, GgufTensorType (+30 more)
...
### Community 129 - "span"
Cohesion: 0.11
Nodes (21): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), detailed_compare(), detailed_device_error(), DetailedError (+13 more)
...
### Community 190 - "LayerPathCapture"
Cohesion: 0.05
Nodes (44): download(), download_bytes(), fingerprint(), GatePathCapture, gate, gated, head_norm, head_scaled (+36 more)
...
### Community 293 - "path_"
Cohesion: 0.23
Nodes (15): path_, argmax(), size_t, span, uint32_t, is_boundary(), is_full_attention_layer(), main() (+7 more)
...
### Community 330 - "string"
Cohesion: 0.08
Nodes (18): string, GemvKernelResources, local_bytes, max_threads_per_block, registers, shared_bytes, size_t, RocblasGemmHandle (+10 more)
...
### Community 392 - "launch_projection"
Cohesion: 0.21
...
### Community 411 - "q4k_layout_bench.cpp"
Cohesion: 0.17
...
## Knowledge Gaps
- **3609 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+3604 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `StageProfile`, `Qwen35RuntimeEngine`, `Qwen35Model`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `LayerPathCapture`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `vector` to `m6a15_qwen35_hybrid_block_audit.cpp`, `m6a3_qwen35_layer.cpp`, `path_`, `validate_position`, `Qwen35Model::load`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `Qwen35Model`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `recurrent_block`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `span`, `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_sequence`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a10_qwen35_q4k_projection.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `Qwen3Layer0KvCache`, `m6a9_qwen35_lm_head.cpp`, `m6a263_qwen35_recurrent_contract.cpp`, `qwen3_forward_test.cpp`, `qwen3_inference_bench.cpp`, `validate_position`, `vector`, `recurrent_block`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `require_match`, `metrics`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `size_t`, `m6a3_qwen35_layer.cpp`, `m6a12_qwen35_attention_projections.cpp`, `qwen35_gpu_pipeline.hpp`, `model_loader_test.cpp`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _3609 weakly-connected nodes found - possible documentation gaps or missing edges._
