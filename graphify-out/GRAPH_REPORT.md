...
## Corpus Check
- 206 files · ~189,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3362 nodes · 5268 edges · 272 communities (244 shown, 28 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 174 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30deda20`
...
### Community 119 - "path_"
Cohesion: 0.05
Nodes (81): ggml_tensor, path_, llama_model, llama_token, llama_vocab, append_string(), append_u32(), append_u64() (+73 more)
...
Cohesion: 0.15
Nodes (26): tensor, array, compare(), uint32_t, read_tokens(), require_match(), rms_rows(), array (+18 more)
...
Cohesion: 0.13
Nodes (34): History, kRecurrentLayers, State, align_up(), cache_fingerprint(), array, size_t, span (+26 more)
...
Cohesion: 0.26
Nodes (23): checkpoint(), conv_output(), array, kChannels, size_t, span, string_view, vector (+15 more)
...
### Community 256 - "m6a9_qwen35_lm_head.cpp"
Cohesion: 0.40
...
### Community 258 - "m6a10_qwen35_q4k_projection.cpp"
Cohesion: 0.39
Nodes (6): size_t, vector, DeviceBuffer, main(), max_abs_error(), read_f32()

### Community 259 - "m6a11_qwen35_attention_prefix.cpp"
Cohesion: 0.39
Nodes (6): size_t, vector, DeviceBuffer, main(), max_abs_error(), read_f32()
...
### Community 262 - "Qwen3Layer0KvCache"
Cohesion: 0.17
...
### Community 266 - "Qwen3TensorView"
Cohesion: 0.33
Nodes (4): byte, GgufTensorType, Qwen3TensorView, source

### Community 267 - "Roadmap Principles"
Cohesion: 0.40
...
### Community 268 - "Current Project Status"
Cohesion: 0.50
Nodes (4): Completed, Completed in Task 3, Current Project Status, Not implemented

### Community 269 - "Metrics"
Cohesion: 0.50
Nodes (4): Metrics, index, max_abs, rmse

### Community 270 - "13. Prefill vs Decode"
Cohesion: 0.67
Nodes (3): 13. Prefill vs Decode, Decode, Prefill

### Community 271 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **1851 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+1846 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `vector`, `recurrent_block`, `Qwen3Model`, `m6a14_qwen35_state_audit.cpp`, `path_`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `validate_position`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_decode_profile.cpp`, `replay_projection`, `qwen3_fast_decode_bench.cpp`, `Qwen3Layer0KvCache`, `Qwen3Config`, `Qwen3GpuPlan`, `Qwen3TensorView`, `model_plan.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `Qwen3LayerWeights`, `qwen3_layer35_external_test.cpp`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Qwen3GpuDecodeWorkspace` connect `Qwen3GpuDecodeWorkspace` to `size_t`, `qwen3_gpu_primitives.hpp`, `qwen3_gpu_layer.cpp`?**
