...
## Corpus Check
- 266 files · ~234,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4236 nodes · 6470 edges · 343 communities (315 shown, 28 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `910e8e41`
...
## Communities (343 total, 28 thin omitted)
...
### Community 50 - "qwen3_gpu_layer.cpp"
Cohesion: 0.12
Nodes (24): capture_qwen3_head_norm(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, uint32_t, execute_qwen3_decode_gpu_greedy(), execute_qwen3_forward_gpu(), launch_projection(), projection_ffn_quantization_stage() (+16 more)
...
Cohesion: 0.24
Nodes (19): llama_model, llama_token, llama_vocab, size_t, string, string_view, uint8_t, vector (+11 more)
...
Cohesion: 0.03
Nodes (59): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+51 more)
...
### Community 123 - "half"
Cohesion: 0.13
Nodes (23): launch_selected_gemv(), int16_t, int8_t, uint8_t, Q4_0Block, d, qs, Q8_1Block (+15 more)
...
Cohesion: 0.15
Nodes (23): Qwen3GpuPlan, buffers_, build, device_, device_tensor_data, kernel_for, model_, tensors_ (+15 more)

### Community 173 - "Q5KDeviceBlock"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (37): FullAttentionLayer, attention, d_attn_norm, d_ffn_down, d_ffn_gate, d_ffn_up, d_k, d_k_norm (+29 more)
...
Cohesion: 0.18
Nodes (34): tensor, main(), checkpoint(), compare(), conv_output(), array, kChannels, size_t (+26 more)
...
Cohesion: 0.15
Nodes (20): RuntimeState, uint32_t, vector, main(), run_combined(), require_match(), array, kChannels (+12 more)
...
Cohesion: 0.15
Nodes (29): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), byte, GgufTensorType, initializer_list (+21 more)
...
Cohesion: 0.29
Nodes (8): size_t, T, vector, DeviceBuffer, data_, main(), recurrent_inputs(), upload()

### Community 274 - "size_t"
Cohesion: 0.13
Nodes (20): Qwen3Projection, Qwen3ProjectionPrecision, capture(), copy_to_host(), size_t, T, vector, DeviceBuffer (+12 more)
...
### Community 289 - "5. Runtime Layers"
Cohesion: 0.29
...
### Community 290 - ".RecurrentLayer"
Cohesion: 0.43
Nodes (4): Buffer, allocate(), upload(), upload_tensor()
...
### Community 299 - "size_t"
Cohesion: 0.15
Nodes (10): size_t, string, uint32_t, DeviceBytes, bytes_, data_, project(), RecurrentTrace (+2 more)
...
### Community 307 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 316 - "Roadmap Principles"
Cohesion: 0.40
...
### Community 318 - "Current Project Status"
Cohesion: 0.50
...
### Community 321 - "13. Prefill vs Decode"
Cohesion: 0.67
...
### Community 323 - "qwen3_layer_gpu_impl"
Cohesion: 0.14
...
### Community 329 - "vector"
Cohesion: 0.07
Nodes (32): vector, main(), measure(), Stats, mean_us, median_us, summarize(), GemvKernelResources (+24 more)

### Community 330 - "DeviceShapeData"
Cohesion: 0.18
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `vector`, `m6a14_qwen35_state_audit.cpp`, `recurrent_inputs`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `run_ladder`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `.RecurrentLayer`, `size_t`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `OutputProjectionPathCapture`, `RecurrentOperands`, `LayerPathCapture`, `Qwen35Config`, `GgufFile`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `model_plan.cpp`, `Qwen3LayerWeights`, `Qwen3GpuDecodeCache`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `Qwen3TensorView`, `qwen3_layer35_external_test.cpp`?**
