...
## Corpus Check
- 323 files · ~257,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4810 nodes · 7057 edges · 391 communities (364 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5598b378`
...
Cohesion: 0.07
Nodes (28): 10. nick413-bit/gfx906-fa-vllm, 11. joe2gaan/localaiservers, 12. AMD gfx906 ISA Documentation, 13. AMD HIP / ROCm Documentation, 14. rocBLAS / hipBLAS, 16. Current Research Synthesis, 18. Research Intake Checklist, 19. External Code Policy (+20 more)
...
Cohesion: 0.21
Nodes (17): Buffer, Q8_1Block, d, qs, s, int16_t, Q8KDeviceBlock, bsums (+9 more)
...
Cohesion: 0.11
Nodes (22): size_t, Qwen3GpuDecodeCache, caches_, prepare, workspace_, Qwen3Layer0GpuKvCache, append, keys_ (+14 more)
...
### Community 245 - "array"
Cohesion: 0.14
Nodes (23): tensor, array, RuntimeState, uint32_t, vector, main(), run_combined(), main() (+15 more)
...
Cohesion: 0.09
Nodes (24): int8_t, uint8_t, Q4KDeviceBlock, d, dmin, qs, scales, Q4KExpandedDeviceBlock (+16 more)
...
### Community 343 - ".get"
Cohesion: 0.15
Nodes (14): allocate(), copy_expanded_q4k(), vector, download(), RecurrentOperands, beta, decay, key (+6 more)
...
### Community 390 - "KeyPathCapture"
Cohesion: 0.33
Nodes (6): KeyPathCapture, input, key, key_norm, normalized, qkv

## Knowledge Gaps
- **2889 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2884 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `Q8_1Block`, `OutputProjectionPathCapture`, `KeyPathCapture`, `path_`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `LayerPathCapture`, `UpdateProvenance`, `size_t`, `GatePathCapture`, `.get`, `Qwen35Config`, `GgufFile`, `FullAttentionLayer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `path_`, `validate_position`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `vector`, `Qwen3Model`, `run_ladder`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_sequence`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `m6a10_qwen35_q4k_projection.cpp`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a9_qwen35_lm_head.cpp`, `Qwen3Layer0KvCache`, `m6a12_qwen35_attention_projections.cpp`, `validate_position`, `size_t`, `Capture`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `main`, `m6a263_qwen35_recurrent_contract.cpp`, `qwen3_layer6_external_test.cpp`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `.get`, `qwen3_decode_sequence_gpu_test.cpp`, `m6a3_qwen35_layer.cpp`, `array`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`, `GgufFile`, `model_loader_test.cpp`, `run_ladder`?**
