...
## Corpus Check
- 267 files · ~235,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4251 nodes · 6489 edges · 337 communities (310 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b1e741c9`
...
Cohesion: 0.03
Nodes (61): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+53 more)
...
### Community 245 - "array"
Cohesion: 0.16
Nodes (23): tensor, array, run_sequence(), require_match(), array, kChannels, size_t, span (+15 more)
...
### Community 274 - ".data"
Cohesion: 0.24
Nodes (14): Qwen3Projection, Qwen3ProjectionPrecision, capture(), copy_to_host(), span, T, vector, execute_qwen3_decode_gpu_fast() (+6 more)
...
Cohesion: 0.12
Nodes (15): Buffer, allocate(), size_t, string, uint32_t, DeviceBytes, bytes_, data_ (+7 more)
...
### Community 323 - "Qwen3Layer0GpuKvCache"
Cohesion: 0.13
...
### Community 335 - "vector"
Cohesion: 0.12
Nodes (9): string, GgufValue, value, GgufScalar, unordered_map, vector, upload, main() (+1 more)
...
## Knowledge Gaps
- **2458 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2453 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `vector`, `recurrent_inputs`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `path_`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `KeyPathCapture`, `size_t`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `RecurrentOperands`, `LayerPathCapture`, `Qwen35Config`, `GgufFile`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `model_plan.cpp`, `Qwen3LayerWeights`, `Qwen3GpuDecodeCache`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
