...
## Corpus Check
- 238 files · ~216,596 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3923 nodes · 6141 edges · 307 communities (280 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 230 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52b97d1d`
...
## Communities (307 total, 27 thin omitted)
...
Cohesion: 0.11
Nodes (27): AttentionKernel, size_t, Qwen3GpuDecodeCache, caches_, prepare, workspace_, Qwen3Layer0GpuKvCache, append (+19 more)
...
Cohesion: 0.14
Nodes (14): vector, GatePathCapture, gate, gated, head_norm, head_scaled, normalized, recurrent_output (+6 more)
...
Cohesion: 0.18
Nodes (14): span, detailed_compare(), detailed_device_error(), DetailedError, max_abs, mean_abs, reference_rms, relative_rms (+6 more)
...
### Community 288 - "Qwen35Model"
Cohesion: 0.29
Nodes (7): shared_ptr, string, Qwen35Model, artifact_path_, config_, load, model_name_

### Community 289 - "main"
Cohesion: 0.21
Nodes (9): uint32_t, download(), GpuLayerRef, attention, recurrent, main(), project(), run_hybrid_block() (+1 more)

### Community 290 - "m6a21_qwen35_gpu_hybrid_block.cpp"
Cohesion: 0.16
Nodes (16): Buffer, allocate(), GgufTensorType, initializer_list, read_external_operands(), RecurrentOperands, beta, decay (+8 more)
...
Cohesion: 0.20
Nodes (10): size_t, string, uint64_t, DeviceBytes, bytes_, data_, fingerprint(), located_device_error() (+2 more)
...
## Knowledge Gaps
- **2208 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2203 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Model`, `Qwen35Config`, `path_`, `vector`, `array`, `m6a15_qwen35_hybrid_block_audit.cpp`, `Qwen3Model`, `recurrent_inputs`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `validate_position`?**
...
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `Qwen35Model`, `main`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `size_t`, `GgufFile`?**
