...
## Corpus Check
- 756 files · ~827,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8670 nodes · 11647 edges · 691 communities (631 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 349 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `106057a4`
...
## Communities (691 total, 60 thin omitted)
...
### Community 97 - "m24_recurrent_layer_bakeoff.cpp"
Cohesion: 0.10
...
### Community 209 - "download"
Cohesion: 0.05
Nodes (51): cosine_similarity(), DecodeLayerCapture, inputs, outputs, detailed_compare(), detailed_device_error(), DetailedError, max_abs (+43 more)
...
Cohesion: 0.16
Nodes (34): main(), upload(), main(), checkpoint(), compare(), conv_output(), array, kChannels (+26 more)
...
Cohesion: 0.05
Nodes (26): b64_composition_enabled(), DeviceBytes, bytes_, data_, exp0380_probe_complete(), exp0385_target_layer(), GpuLayerRef, attention (+18 more)
...
Cohesion: 0.11
Nodes (33): tensor, argmax(), path, size_t, span, uint32_t, is_boundary(), is_full_attention_layer() (+25 more)
...
### Community 559 - "q4_q8_gemv_reference.cpp"
Cohesion: 0.36
...
Cohesion: 0.09
Nodes (23): size_t, unique_ptr, vector, Qwen3FfnProbeTrace, ffn_output, gate, layer_output, swiglu (+15 more)
...
### Community 682 - "DeviceBuffer"
Cohesion: 0.40
Nodes (4): size_t, T, DeviceBuffer, data_

### Community 683 - "StepResult"
Cohesion: 0.67
...
## Knowledge Gaps
- **5499 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+5494 more)
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M26CDecodeResult`, `m24_recurrent_layer_bakeoff.cpp`, `WidePrefillWorkspace`, `size_t`, `RemainderSchedulerCounters`, `SessionPrefixNode`, `uint32_t`, `StepResult`, `Qwen35Model`, `qwen3_tokenizer.cpp`, `RecurrentLayer`, `FullAttentionLayer`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `qwen35_gpu_pipeline.hpp`, `PrefillProfile`, `SessionCheckpoint`, `size_t`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `m24_recurrent_layer_bakeoff.cpp`, `StageProfile`, `qwen3_gpu_primitives.hpp`, `Qwen35Model`, `Qwen35RuntimeEngine`, `download`, `M23ProfileCounters`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `m24_recurrent_layer_bakeoff.cpp`, `StageProfile`, `LayerPathCapture`, `qwen3_gpu_primitives.hpp`, `Qwen35Model`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `download`, `miinfer_cli.cpp`, `M23ProfileCounters`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`, `GatePathCapture`, `UpdateProvenance`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _5499 weakly-connected nodes found - possible documentation gaps or missing edges._
