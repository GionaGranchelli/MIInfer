...
## Corpus Check
- 260 files · ~230,883 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4167 nodes · 6406 edges · 330 communities (303 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3631b5b8`
...
## Communities (330 total, 27 thin omitted)
...
### Community 50 - "Qwen3GpuDecodeCache"
Cohesion: 0.13
...
### Community 163 - "span"
Cohesion: 0.12
Nodes (25): size_t, span, Qwen3DecodeCache, caches_, length, Qwen3Layer0KvCache, append, reset (+17 more)
...
### Community 245 - "path_"
Cohesion: 0.21
Nodes (17): path_, tensor, RuntimeState, run_sequence(), uint32_t, vector, main(), run_combined() (+9 more)
...
Cohesion: 0.08
Nodes (40): set, argmax(), size_t, string, uint32_t, vector, main(), parse_count() (+32 more)
...
### Community 273 - "array"
Cohesion: 0.15
Nodes (13): array, size_t, T, vector, DeviceBuffer, data_, main(), recurrent_inputs() (+5 more)
...
## Knowledge Gaps
- **2389 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2384 more)
...
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `array`, `Qwen3Model`, `path_`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `run_ladder`?**
...
- **Why does `Qwen3Model` connect `Qwen3Model` to `Qwen3TensorView`, `model_plan.cpp`, `span`, `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `Qwen3LayerWeights`, `qwen3_decode_sequence_gpu_test.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `vector`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
