...
## Corpus Check
- 751 files · ~821,060 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8575 nodes · 11523 edges · 690 communities (630 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 333 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ea508ad`
...
## Communities (690 total, 60 thin omitted)
...
Cohesion: 0.05
Nodes (18): DeviceBytes, bytes_, data_, exp0380_b64_probe_enabled(), exp0380_probe_complete(), exp0380_probe_layer(), GpuLayerRef, attention (+10 more)
...
Cohesion: 0.15
Nodes (12): B128 comparison, Decision, Exact next PRIMARY, EXP-0379 evidence, EXP-0380 — Localize the first B64 attention-composition hang, Extended sparse-ladder evidence, Host wait evidence, Lifecycle follow-up (+4 more)
...
Cohesion: 0.04
Nodes (49): Authorization gate, Candidate architecture, Decision gate after M26-F, Exit, Exit, Exit artifact, Goal, Goal (+41 more)
...
Cohesion: 0.11
Nodes (37): pack_mx_q4k_repacked_tensor(), pack_q4k_mmq_tensor(), allocate(), count, combined_attn_qk_enabled(), combined_qkv_gate_enabled(), configured_wide_prefill_batch(), copy_combined_q4k_mmq_tensors() (+29 more)
...
### Community 639 - "Qwen3ForwardTrace"
Cohesion: 0.13
...
### Community 648 - ".get"
Cohesion: 0.08
Nodes (22): DecodeLayerCapture, inputs, outputs, download(), download_bytes(), Q8_1Block, vector, project() (+14 more)
...
### Community 659 - "qwen3_swiglu_q8_bench.cpp"
Cohesion: 0.39
...
### Community 669 - "LayerPathCapture"
Cohesion: 0.08
Nodes (23): GatePathCapture, gate, gated, head_norm, head_scaled, normalized, recurrent_output, KeyPathCapture (+15 more)

### Community 670 - "string"
Cohesion: 0.09
Nodes (12): string, GemvKernelResources, local_bytes, max_threads_per_block, registers, shared_bytes, size_t, string (+4 more)
...
### Community 682 - "M4 — First Correct End-to-End Generation"
Cohesion: 0.33
...
### Community 688 - "DeviceShapeData"
Cohesion: 0.10
Nodes (23): Q8_1Block, DeviceShapeData, device_input_fp16, device_input_q8, device_output, device_weights, input_fp16, input_q8 (+15 more)
...
## Knowledge Gaps
- **5426 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+5421 more)
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M26CDecodeResult`, `WidePrefillWorkspace`, `size_t`, `RemainderSchedulerCounters`, `Qwen35Model`, `SessionPrefixNode`, `qwen3_tokenizer.cpp`, `RecurrentLayer`, `FullAttentionLayer`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `StepTransferMetrics`, `SessionCheckpoint`, `PrefillProfile`, `main`, `qwen35_gpu_pipeline.hpp`, `size_t`, `m12_gdn_chunk_bench.cpp`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `StageProfile`, `GgufTensor`, `Qwen35Model`, `.get`, `half`, `Qwen35RuntimeEngine`, `qwen35_gpu_pipeline.hpp`, `size_t`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `StageProfile`, `GgufTensor`, `Qwen35Model`, `.get`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `half`, `miinfer_cli.cpp`, `main`, `qwen35_gpu_pipeline.hpp`, `size_t`, `LayerPathCapture`, `UpdateProvenance`, `m12_gdn_chunk_bench.cpp`?**
