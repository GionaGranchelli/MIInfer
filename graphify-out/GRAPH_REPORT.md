...
## Corpus Check
- 284 files · ~245,155 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4451 nodes · 6722 edges · 356 communities (329 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `96be6665`
...
## Communities (356 total, 27 thin omitted)
...
Cohesion: 0.13
Nodes (23): size_t, vector, Qwen3DecodeCache, caches_, length, reset, Qwen3Layer0KvCache, append (+15 more)
...
Cohesion: 0.04
Nodes (44): FullAttentionLayer, attention, batch_head_rms, d_attn_norm, d_ffn_down, d_ffn_gate, d_ffn_up, d_k (+36 more)
...
### Community 321 - "vector"
Cohesion: 0.11
Nodes (9): string, GgufValue, value, GgufScalar, unordered_map, vector, array, span (+1 more)
...
Cohesion: 0.13
Nodes (17): vector, download(), GatePathCapture, gate, gated, head_norm, head_scaled, normalized (+9 more)
...
### Community 355 - "Checkpoint"
Cohesion: 0.40
Nodes (5): Checkpoint, file, miinfer, name, tolerance

## Knowledge Gaps
- **2611 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2606 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `OutputProjectionPathCapture`, `size_t`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `KeyPathCapture`, `.get`, `RecurrentOperands`, `Qwen35Config`, `GgufFile`, `LayerPathCapture`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `vector`, `m6a15_qwen35_hybrid_block_audit.cpp`, `path_`, `validate_position`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `vector`, `qwen3_fast_decode_bench.cpp`, `model_plan.cpp`, `qwen3_decode_sequence_gpu_test.cpp`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_layer35_external_test.cpp`, `qwen3_layer_host_impl`, `Qwen3Config`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `Qwen3LayerWeights`, `execute_qwen3_decode_host`?**
