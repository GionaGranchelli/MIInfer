...
## Corpus Check
- 292 files · ~247,919 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4526 nodes · 6789 edges · 368 communities (341 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3958b619`
...
## Communities (368 total, 27 thin omitted)
...
### Community 123 - "half"
Cohesion: 0.12
Nodes (23): int16_t, int8_t, uint8_t, Q4_0Block, d, qs, Q8ExactBlock, d (+15 more)
...
Cohesion: 0.09
Nodes (38): set, argmax(), compare(), compare_checkpoint(), size_t, vector, fp16_round_trip(), main() (+30 more)
...
Cohesion: 0.13
Nodes (28): AttentionKernel, Function, capture_qwen3_head_norm(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, launch_projection(), profile_copy_call(), profile_gpu_call() (+20 more)
...
### Community 322 - "qwen3_decode_profile.cpp"
Cohesion: 0.18
...
### Community 337 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 358 - "qwen3_gpu_layer.hpp"
Cohesion: 0.15
...
### Community 366 - "OutputProjectionPathCapture"
Cohesion: 0.33
...
## Knowledge Gaps
- **2670 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2665 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `GatePathCapture`, `KeyPathCapture`, `.get`, `LayerPathCapture`, `OutputProjectionPathCapture`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `size_t`, `.run`, `Qwen35Config`, `GgufFile`, `Q8_1Block`, `FullAttentionLayer`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `vector`, `path_`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_decode_profile.cpp`, `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `model_plan.cpp`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
