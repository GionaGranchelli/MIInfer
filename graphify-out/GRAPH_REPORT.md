...
## Corpus Check
- 302 files · ~251,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4618 nodes · 6871 edges · 379 communities (352 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ed7b4b5`
...
### Community 129 - "qwen3_gpu_primitives.hpp"
Cohesion: 0.15
...
### Community 168 - ".get"
Cohesion: 0.17
Nodes (15): Buffer, int16_t, Q8KDeviceBlock, bsums, d, qs, allocate(), uint32_t (+7 more)
...
Cohesion: 0.04
Nodes (46): FullAttentionLayer, attention, batch_head_rms, d_attn_norm, d_ffn_down, d_ffn_gate, d_ffn_up, d_k (+38 more)
...
### Community 337 - "qwen3_gpu_layer.hpp"
Cohesion: 0.15
...
Cohesion: 0.14
Nodes (16): vector, download(), KeyPathCapture, input, key, key_norm, normalized, qkv (+8 more)
...
### Community 378 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **2742 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2737 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `LayerPathCapture`, `StageProfile`, `.get`, `GatePathCapture`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `OutputProjectionPathCapture`, `size_t`, `RecurrentOperands`, `Qwen35Config`, `GgufFile`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `path_`, `vector`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `run_ladder`, `recurrent_block`, `Qwen35Config`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `gguf.cpp`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `model_plan.cpp`, `vector`, `qwen3_decode_profile.cpp`, `qwen3_inference_bench.cpp`, `Qwen3Config`, `qwen3_tokenizer.cpp`, `print_text`, `qwen3_layer_host_impl`, `gguf.cpp`, `GgufFile`, `Qwen3LayerWeights`, `qwen3_layer35_external_test.cpp`?**
