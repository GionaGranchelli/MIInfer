...
## Corpus Check
- 436 files · ~348,557 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6068 nodes · 8473 edges · 521 communities (466 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a32ce80`
...
- m6a17_qwen35_composition_ladder.cpp
...
## Communities (521 total, 55 thin omitted)
...
Cohesion: 0.11
Nodes (40): GgufTensor, byte_size, data, dimensions, name, offset, type, byte (+32 more)

### Community 122 - "q4_q8_gemv.hpp"
Cohesion: 0.11
Nodes (22): int16_t, int8_t, uint8_t, Q4_0Block, d, qs, Q8_1Block, d (+14 more)

### Community 123 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 129 - "path_"
Cohesion: 0.12
Nodes (24): path_, RuntimeState, uint32_t, vector, main(), run_combined(), main(), uint32_t (+16 more)
...
Cohesion: 0.12
Nodes (33): AttentionKernel, Qwen3Projection, Qwen3ProjectionPrecision, capture(), capture_qwen3_head_norm(), copy_to_host(), size_t, span (+25 more)
...
Cohesion: 0.20
Nodes (28): main(), checkpoint(), compare(), conv_output(), array, kChannels, size_t, span (+20 more)
...
Cohesion: 0.10
Nodes (25): validate_cache(), size_t, unique_ptr, Qwen3GpuDecodeCache, caches_, length, prepare, reset (+17 more)
...
### Community 297 - "launch_projection"
Cohesion: 0.21
...
### Community 318 - "m6a17_qwen35_composition_ladder.cpp"
Cohesion: 0.39
Nodes (7): argmax(), size_t, span, is_boundary(), is_full_attention_layer(), main(), print_ledger()
...
### Community 404 - "RecurrentOperands"
Cohesion: 0.10
Nodes (23): download(), GatePathCapture, gate, gated, head_norm, head_scaled, normalized, recurrent_output (+15 more)
...
### Community 409 - "span"
Cohesion: 0.15
Nodes (19): size_t, span, Qwen3Layer0KvCache, append, reset, Qwen3DecodeCache::reset(), cache_contract_test(), checkpoint_tolerance() (+11 more)
...
Cohesion: 0.11
Nodes (34): tensor, uint32_t, run_ladder(), f32_values(), rms_rows(), cached_attention(), Metrics, size_t (+26 more)
...
Cohesion: 0.09
Nodes (16): string, RocblasGemmHandle, opaque, GgufValue, value, GgufScalar, unordered_map, vector (+8 more)
...
Cohesion: 0.08
Nodes (12): cosine_similarity(), DeviceBytes, bytes_, data_, first_argmax(), GpuLayerRef, attention, recurrent (+4 more)
...
### Community 483 - "Qwen3LayerWeights"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (15): ByteMismatch, count, first, compare_bytes(), download_bytes(), fingerprint(), host_fingerprint(), byte (+7 more)
...
Cohesion: 0.14
Nodes (16): string, main(), run_q5k_benchmark(), run_q6k_benchmark(), shared_ptr, string, Qwen35Model, artifact_path_ (+8 more)

### Community 501 - "StepResult"
Cohesion: 0.67
Nodes (3): StepResult, latency_ms, token

### Community 502 - "qwen3_gpu_layer.hpp"
Cohesion: 0.15
...
### Community 503 - "qwen3_generate.cpp"
Cohesion: 0.40
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `LayerPathCapture`, `StageProfile`, `OutputProjectionPathCapture`, `Qwen35RuntimeEngine`, `Qwen35Model`, `RecurrentOperands`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `.run`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `path_`, `m6a15_qwen35_hybrid_block_audit.cpp`, `m6a3_qwen35_layer.cpp`, `vector`, `Qwen35Model::load`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Qwen35Model`, `recurrent_block`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_sequence`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a10_qwen35_q4k_projection.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `span`, `m6a9_qwen35_lm_head.cpp`, `m6a263_qwen35_recurrent_contract.cpp`, `qwen3_forward_test.cpp`, `model_loader_test.cpp`, `GgufFile`, `recurrent_block`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `m6a17_qwen35_composition_ladder.cpp`, `.run`, `require_match`, `qwen3_layer6_external_test.cpp`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `m6a3_qwen35_layer.cpp`, `m6a12_qwen35_attention_projections.cpp`, `qwen35_gpu_pipeline.hpp`, `qwen3_decode_sequence_gpu_test.cpp`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _3696 weakly-connected nodes found - possible documentation gaps or missing edges._
