...
## Corpus Check
- 204 files · ~188,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3315 nodes · 5158 edges · 266 communities (238 shown, 28 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 168 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `704fbae9`
...
### Community 119 - "path_"
Cohesion: 0.06
Nodes (70): ggml_tensor, path_, llama_model, llama_token, llama_vocab, argmax(), compare(), compare_checkpoint() (+62 more)
...
Cohesion: 0.21
Nodes (11): GemvShape, id, k, m, projection, RocblasGemmHandle, opaque, check_output() (+3 more)
...
Cohesion: 0.05
Nodes (93): tensor, array, Metrics, uint32_t, vector, evaluate_fp16_gemv(), fp16_gemv_cpu_reference(), generate_fp16_gemv_data() (+85 more)
...
### Community 250 - "Qwen35Model::load"
Cohesion: 0.42
...
## Knowledge Gaps
- **1835 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+1830 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Model`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `path_`, `gguf.cpp`, `vector`, `Qwen35Model::load`, `GgufTensor`?**
...
- **Why does `Qwen3GpuPlan` connect `Qwen3GpuPlan` to `qwen3_decode_profile.cpp`, `qwen3_fast_decode_bench.cpp`, `qwen3_forward_gpu_test.cpp`, `Qwen3GpuDecodeCache`, `ProfileScope`, `model_plan.cpp`, `qwen3_attention_ab_bench.cpp`, `qwen3_layer6_external_test.cpp`, `Qwen3Model`, `qwen3_gpu_layer.hpp`, `DeviceInfo`, `qwen3_layer35_external_test.cpp`, `qwen3_inference_bench.cpp`, `qwen3_gpu_layer.cpp`?**
