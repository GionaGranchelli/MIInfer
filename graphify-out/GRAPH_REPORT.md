...
## Corpus Check
- 751 files · ~821,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8576 nodes · 11524 edges · 697 communities (637 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 333 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8457a44`
...
## Communities (697 total, 60 thin omitted)
...
Cohesion: 0.09
Nodes (51): main(), GgufTensor, byte_size, data, dimensions, name, offset, type (+43 more)
...
### Community 217 - "half"
Cohesion: 0.19
Nodes (30): main(), checkpoint(), compare(), conv_output(), array, kChannels, path, size_t (+22 more)
...
Cohesion: 0.05
Nodes (20): DecodeLayerCapture, inputs, outputs, DeviceBytes, bytes_, data_, download(), download_bytes() (+12 more)
...
Cohesion: 0.09
Nodes (19): as(), Buffer, pointer, Fn, hipEvent_t, size_t, string, T (+11 more)
...
Cohesion: 0.14
Nodes (13): B128 comparison, Clean exact-P960 sparse-ladder reruns, Decision, Exact next PRIMARY, EXP-0379 evidence, EXP-0380 — Localize the first B64 attention-composition hang, Extended sparse-ladder evidence, Host wait evidence (+5 more)
...
### Community 378 - "uint32_t"
Cohesion: 0.19
Nodes (5): exp0380_b64_probe_enabled(), exp0380_probe_complete(), exp0380_probe_layer(), uint32_t, run_hybrid_block()
...
Cohesion: 0.11
Nodes (23): GenerateOptions, GenerateStats, cmd_run(), function, path, size_t, span, uint32_t (+15 more)
...
### Community 574 - "m24_recurrent_layer_bakeoff.cpp"
Cohesion: 0.10
...
### Community 603 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 652 - "qwen3_layer_gpu_impl"
Cohesion: 0.16
Nodes (26): size_t, Qwen3Layer0GpuKvCache, append, keys_, values_, capture_qwen3_head_norm(), size_t, span (+18 more)
...
### Community 679 - "5. Runtime Layers"
Cohesion: 0.29
...
### Community 683 - "M1 — Kernel Laboratory"
Cohesion: 0.29
...
### Community 693 - "EXP-0352 raw comparison artifacts — 2026-09-20"
Cohesion: 0.33
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M26CDecodeResult`, `WidePrefillWorkspace`, `size_t`, `RemainderSchedulerCounters`, `m24_recurrent_layer_bakeoff.cpp`, `SessionPrefixNode`, `qwen3_tokenizer.cpp`, `RecurrentLayer`, `FullAttentionLayer`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `StepTransferMetrics`, `SessionCheckpoint`, `PrefillProfile`, `qwen35_gpu_pipeline.hpp`, `size_t`, `Qwen35Model`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `M23ProfileCounters`, `StageProfile`, `GgufTensor`, `Metadata`, `uint32_t`, `Qwen35RuntimeEngine`, `RecurrentOperands`, `size_t`, `half`, `qwen35_gpu_pipeline.hpp`, `Qwen35Model`, `m24_recurrent_layer_bakeoff.cpp`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `M23ProfileCounters`, `StageProfile`, `GgufTensor`, `Metadata`, `Qwen35Model`, `uint32_t`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `GatePathCapture`, `RecurrentOperands`, `miinfer_cli.cpp`, `UpdateProvenance`, `KeyPathCapture`, `half`, `qwen35_gpu_pipeline.hpp`, `size_t`, `LayerPathCapture`, `m24_recurrent_layer_bakeoff.cpp`?**
