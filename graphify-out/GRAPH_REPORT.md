...
## Corpus Check
- 755 files · ~826,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8653 nodes · 11626 edges · 695 communities (635 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 349 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c3d3794`
...
## Communities (695 total, 60 thin omitted)
...
Cohesion: 0.07
Nodes (29): Completed, Completed in Task 3, Current Benchmark Priority, Current Build Direction, Current Correctness Policy, Current Dependency Policy, Current Experiment Queue, Current experiment status — EXP-0382 (+21 more)
...
### Community 36 - "vector"
Cohesion: 0.07
Nodes (21): as(), Buffer, p, hipEvent_t, size_t, T, Event, p (+13 more)
...
Cohesion: 0.08
Nodes (21): array, Buffer, path, span, uint32_t, SessionCheckpoint, boundary_position, execution_contract_version (+13 more)
...
Cohesion: 0.08
Nodes (19): PrefillProfile, attention_layers, chunks, decode_mode, embedding_end, embedding_ms, embedding_start, enabled (+11 more)
...
Cohesion: 0.14
Nodes (21): GenerateOptions, GenerateStats, function, size_t, count, opt_prefill_checkpoint_, RuntimeGenerateOptions, max_new_tokens (+13 more)
...
Cohesion: 0.10
Nodes (23): int16_t, int8_t, M23Q8_1MmqBlock, d, qs, qsum_scaled, s, MxQ8_1MmqBlock (+15 more)
...
### Community 559 - "half"
Cohesion: 0.14
Nodes (22): uint8_t, Q4_0Block, d, qs, uint32_t, launch_qwen35_fused_k_norm_rope_kv_store(), launch_qwen35_tiled_online_attention(), launch_qwen3_kv_cache_store() (+14 more)
...
### Community 640 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 669 - ".run"
Cohesion: 0.06
Nodes (31): DecodeLayerCapture, inputs, outputs, download(), download_bytes(), GatePathCapture, gate, gated (+23 more)

### Community 670 - "Qwen3Config"
Cohesion: 0.17
...
### Community 685 - "qwen3_primitives_test.cpp"
Cohesion: 0.43
...
### Community 688 - "M4 — First Correct End-to-End Generation"
Cohesion: 0.33
...
### Community 690 - "GemvKernelResources"
Cohesion: 0.33
...
## Knowledge Gaps
- **5487 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+5482 more)
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M26CDecodeResult`, `WidePrefillWorkspace`, `size_t`, `RemainderSchedulerCounters`, `SessionPrefixNode`, `SessionCheckpoint`, `Qwen35Model`, `qwen3_tokenizer.cpp`, `RecurrentLayer`, `FullAttentionLayer`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `StepTransferMetrics`, `PrefillProfile`, `qwen35_gpu_pipeline.hpp`, `size_t`, `m12_gdn_chunk_bench.cpp`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `StageProfile`, `Qwen35Model`, `half`, `Qwen35RuntimeEngine`, `uint32_t`, `M23ProfileCounters`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`, `.run`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `StageProfile`, `LayerPathCapture`, `Qwen35Model`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `half`, `main`, `miinfer_cli.cpp`, `uint32_t`, `M23ProfileCounters`, `qwen35_gpu_pipeline.hpp`, `GgufTensor`, `size_t`, `.run`, `UpdateProvenance`, `m12_gdn_chunk_bench.cpp`?**
