...
## Corpus Check
- 231 files · ~212,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3829 nodes · 6043 edges · 296 communities (269 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 229 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `130b791b`
...
## Communities (296 total, 27 thin omitted)
...
Cohesion: 0.04
Nodes (47): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+39 more)
...
Cohesion: 0.18
Nodes (26): ostream, string, vector, escape(), main(), median(), nonnegative(), Options (+18 more)
...
Cohesion: 0.06
Nodes (44): size_t, string, json_escape(), main(), Options, device, elements, iterations (+36 more)

### Community 166 - "vector"
Cohesion: 0.08
Nodes (20): string, GemvKernelResources, local_bytes, max_threads_per_block, registers, shared_bytes, size_t, RocblasGemmHandle (+12 more)
...
Cohesion: 0.19
Nodes (31): main(), checkpoint(), compare(), conv_output(), array, kChannels, size_t, span (+23 more)
...
Cohesion: 0.17
Nodes (12): DeviceShapeData, device_input_fp16, device_input_q8, device_output, device_weights, input_fp16, input_q8, oracle_fp16 (+4 more)
...
Cohesion: 0.14
Nodes (24): span, uint64_t, detailed_compare(), detailed_device_error(), DetailedError, max_abs, mean_abs, reference_rms (+16 more)
...
### Community 286 - "qwen3_gpu_primitives.hpp"
Cohesion: 0.09
...
## Knowledge Gaps
- **2131 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2126 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `array`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_ladder`, `vector`, `path_`, `Qwen3Model`, `m6a14_qwen35_state_audit.cpp`, `recurrent_inputs`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `validate_position`, `Qwen35Model`?**
...
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `.get`, `size_t`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `GgufFile`, `Qwen35Model`?**
