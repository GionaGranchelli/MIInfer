...
## Corpus Check
- 263 files · ~232,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4200 nodes · 6436 edges · 332 communities (305 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7dcff2b9`
...
Cohesion: 0.14
Nodes (32): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), byte, GgufTensorType, initializer_list (+24 more)
...
### Community 290 - ".get"
Cohesion: 0.23
Nodes (5): Buffer, allocate(), project(), upload(), upload_tensor()
...
### Community 330 - "OutputProjectionPathCapture"
Cohesion: 0.33
...
## Knowledge Gaps
- **2416 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2411 more)
...
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `Qwen35Model`, `m6a15_qwen35_hybrid_block_audit.cpp`, `vector`, `validate_position`, `recurrent_inputs`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `path_`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `Qwen35Model`, `.get`, `RecurrentOperands`, `OutputProjectionPathCapture`, `size_t`, `StageProfile`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `GatePathCapture`, `LayerPathCapture`, `GgufFile`, `KeyPathCapture`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `Qwen3GpuPlan`, `Qwen3LayerWeights`, `qwen3_decode_profile.cpp`, `Qwen3TensorView`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `model_plan.cpp`, `gguf.cpp`, `GgufFile`, `Qwen3GpuDecodeCache`, `qwen3_layer35_external_test.cpp`?**
