...
## Corpus Check
- 763 files · ~833,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8738 nodes · 11714 edges · 710 communities (649 shown, 61 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 351 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `96a08e33`
...
## Communities (710 total, 61 thin omitted)
...
### Community 24 - "qwen3_swiglu_q8_bench.cpp"
Cohesion: 0.39
...
### Community 36 - "qwen3_primitives_test.cpp"
Cohesion: 0.43
...
Cohesion: 0.10
Nodes (22): int16_t, Q8KDeviceBlock, bsums, d, qs, b64_composition_enabled(), exp0385_target_layer(), Q8_1Block (+14 more)
...
Cohesion: 0.05
Nodes (31): as(), Buffer, pointer, Fn, hipEvent_t, size_t, string, T (+23 more)
...
### Community 479 - "Qwen3GpuDecodeCache"
Cohesion: 0.10
...
Cohesion: 0.12
Nodes (19): DeviceDecodeState, current_token, generated, max_generated, position, stop, int8_t, uint32_t (+11 more)
...
Cohesion: 0.08
Nodes (52): main(), GgufTensor, byte_size, data, dimensions, name, offset, type (+44 more)
...
### Community 665 - "download"
Cohesion: 0.05
Nodes (41): DecodeLayerCapture, inputs, outputs, download(), GatePathCapture, gate, gated, head_norm (+33 more)
...
### Community 672 - "EXP-0352 raw comparison artifacts — 2026-09-20"
Cohesion: 0.33
...
### Community 680 - "model_loader_test.cpp"
Cohesion: 0.32
...
Cohesion: 0.13
Nodes (14): Additional quantization, Architectural rule, Core runtime responsibilities, Exit criteria, Goal, Long-context specialization, M3 — Minimal Runtime, M7 — Expansion (+6 more)

### Community 684 - "DeviceBuffer"
Cohesion: 0.36
Nodes (5): size_t, T, DeviceBuffer, count_, data_

### Community 685 - "StepTransferMetrics"
Cohesion: 0.40
...
### Community 697 - "Qwen3LayerWeights"
Cohesion: 0.17
...
### Community 699 - "main"
Cohesion: 0.24
Nodes (9): Q6KDeviceBlock, d, qh, ql, scales, close(), close_mmq(), close_q6_mmq() (+1 more)
...
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `Qwen35Model`, `RemainderSchedulerCounters`, `qwen35_gpu_pipeline.hpp`, `WidePrefillWorkspace`, `uint32_t`, `StepTransferMetrics`, `RuntimeGenerateStats`, `RecurrentLayer`, `FullAttentionLayer`, `size_t`, `StepResult`, `Exp0376ChunkTiming`, `miinfer_cli.cpp`, `m12_gdn_chunk_bench.cpp`, `M26CDecodeResult`, `qwen3_tokenizer.cpp`, `PrefillProfile`, `SessionCheckpoint`, `size_t`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `Qwen35Model`, `uint32_t`, `size_t`, `kquant_wave_layout.cpp`, `Qwen35RuntimeEngine`, `StageProfile`, `main`, `download`, `qwen35_gpu_pipeline.hpp`, `size_t`, `half`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `Qwen35Model`, `uint32_t`, `UpdateProvenance`, `kquant_wave_layout.cpp`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `half`, `StageProfile`, `miinfer_cli.cpp`, `main`, `download`, `qwen35_gpu_pipeline.hpp`, `size_t`, `m12_gdn_chunk_bench.cpp`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _5551 weakly-connected nodes found - possible documentation gaps or missing edges._
