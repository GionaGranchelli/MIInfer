...
## Corpus Check
- 322 files · ~257,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4802 nodes · 7050 edges · 393 communities (366 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd20f365`
...
## Communities (393 total, 27 thin omitted)
...
### Community 129 - "Q8_1Block"
Cohesion: 0.32
Nodes (12): Buffer, Q8_1Block, d, qs, s, uint32_t, project(), project_q4_q8_1() (+4 more)
...
Cohesion: 0.09
Nodes (22): size_t, vector, Qwen3DownProjectionContractTrace, current_s_correction, direct_signed_oracle, exact_sum_correction, Qwen3GpuDecodeCache, caches_ (+14 more)
...
### Community 161 - "Qwen3TensorView"
Cohesion: 0.15
Nodes (15): AccumulationContract, byte, GgufTensorType, Qwen3TensorView, source, int16_t, int8_t, size_t (+7 more)
...
Cohesion: 0.10
Nodes (38): allocate(), ByteMismatch, count, first, compare_bytes(), copy_expanded_q4k(), cosine_similarity(), byte (+30 more)
...
### Community 276 - "vector"
Cohesion: 0.11
Nodes (10): string, vector, upload, main(), size_t, vector, DeviceBuffer, main() (+2 more)
...
### Community 362 - "Qwen3GpuProfileEvent"
Cohesion: 0.14
...
### Community 363 - "qwen3_swiglu_q8_bench.cpp"
Cohesion: 0.39
...
### Community 375 - "Qwen3LayerWeights"
Cohesion: 0.08
...
### Community 390 - "11. joe2gaan/localaiservers"
Cohesion: 0.50
Nodes (4): 11. joe2gaan/localaiservers, Important dot-product lesson, MIInfer implication, Role

### Community 391 - "13. Prefill vs Decode"
Cohesion: 0.67
Nodes (3): 13. Prefill vs Decode, Decode, Prefill

### Community 392 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **2883 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2878 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `Q8_1Block`, `GpuLayerRef`, `OutputProjectionPathCapture`, `path_`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `LayerPathCapture`, `UpdateProvenance`, `size_t`, `RecurrentOperands`, `Qwen35Config`, `GgufFile`, `FullAttentionLayer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `path_`, `validate_position`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `vector`, `array`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `run_ladder`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_sequence`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `m6a10_qwen35_q4k_projection.cpp`, `vector`, `m6a9_qwen35_lm_head.cpp`, `Qwen3Layer0KvCache`, `m6a12_qwen35_attention_projections.cpp`, `validate_position`, `size_t`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `require_match`, `m6a263_qwen35_recurrent_contract.cpp`, `metrics`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `RecurrentOperands`, `qwen3_decode_sequence_gpu_test.cpp`, `m6a3_qwen35_layer.cpp`, `array`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`, `GgufFile`, `model_loader_test.cpp`, `run_ladder`?**
