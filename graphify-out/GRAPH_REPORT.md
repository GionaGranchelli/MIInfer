...
## Corpus Check
- 441 files · ~351,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6130 nodes · 8532 edges · 520 communities (465 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e224b40b`
...
## Communities (520 total, 55 thin omitted)
...
Cohesion: 0.07
Nodes (49): ostream, string, uint32_t, vector, implementation_label(), json_escape(), main(), median_of() (+41 more)
...
### Community 33 - "vector"
Cohesion: 0.09
Nodes (21): GemvKernelResources, local_bytes, max_threads_per_block, registers, shared_bytes, size_t, RocblasGemmHandle, opaque (+13 more)
...
Cohesion: 0.02
Nodes (113): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_gate_native, d_attn_norm (+105 more)
...
### Community 186 - "qwen3_decode_sequence_gpu_test.cpp"
Cohesion: 0.24
...
### Community 252 - "memory_stream_bench.cpp"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (17): size_t, Qwen3Layer0GpuKvCache, append, keys_, snapshot_keys, snapshot_values, values_, uint32_t (+9 more)
...
### Community 330 - "qwen3_gpu_layer.cpp"
Cohesion: 0.06
Nodes (46): AttentionKernel, reset, capture_qwen3_head_norm(), Function, hipEvent_t, Q8_1Block, Qwen3BoundaryProfileStage, Qwen3FfnProfileStage (+38 more)
...
### Community 374 - "kquant_wave_layout.cpp"
Cohesion: 0.31
...
### Community 375 - "q4k_layout_bench.cpp"
Cohesion: 0.17
...
### Community 436 - "array"
Cohesion: 0.12
Nodes (27): tensor, array, RuntimeState, uint32_t, vector, main(), run_combined(), f32_values() (+19 more)
...
### Community 454 - "kquant_layout_bench.cpp"
Cohesion: 0.16
...
### Community 483 - "5. Runtime Layers"
Cohesion: 0.29
...
### Community 485 - "qwen3_generate.cpp"
Cohesion: 0.40
...
### Community 488 - "M4 — First Correct End-to-End Generation"
Cohesion: 0.33
...
Cohesion: 0.25
Nodes (7): hip_check(), hip_check_failed(), hipError_t, check_output(), vector, main(), run_shape()

### Community 500 - "Qwen35Model::load"
Cohesion: 0.42
...
### Community 502 - "Qwen3GpuDecodeCache"
Cohesion: 0.10
Nodes (21): validate_cache(), unique_ptr, vector, Qwen3DownProjectionContractTrace, current_s_correction, direct_signed_oracle, exact_sum_correction, Qwen3FfnProbeTrace (+13 more)
...
### Community 508 - "Qwen35TensorView"
Cohesion: 0.22
...
### Community 518 - "13. Prefill vs Decode"
Cohesion: 0.67
Nodes (3): 13. Prefill vs Decode, Decode, Prefill

### Community 519 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **3747 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+3742 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `main`, `LayerPathCapture`, `Qwen35RuntimeEngine`, `RecurrentOperands`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `.run`, `Qwen35Model`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `vector`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a3_qwen35_layer.cpp`, `path_`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `run_ladder`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Qwen35Model::load`, `array`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`, `Qwen35Model`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `GgufTensor` connect `qwen35_gpu_pipeline.hpp` to `require_match`, `vector`, `Qwen3TensorView`, `Q5KWaveTile`, `GgufFile`, `RecurrentLayer`, `FullAttentionLayer`, `array`, `kquant_wave_layout.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen35TensorView`, `.run`?**
