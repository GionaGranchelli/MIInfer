...
## Corpus Check
- 669 files · ~741,866 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7503 nodes · 10253 edges · 630 communities (571 shown, 59 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 322 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08dc691d`
...
## Communities (630 total, 59 thin omitted)
...
### Community 32 - ".get"
Cohesion: 0.11
Nodes (12): Q8_1Block, string, uint32_t, project(), project_native_down(), project_native_q6k_down(), project_q4_q8_1(), project_q4_q8_1_expanded() (+4 more)
...
Cohesion: 0.06
Nodes (37): int16_t, int8_t, uint8_t, M23Q8_1MmqBlock, d, qs, qsum_scaled, s (+29 more)
...
Cohesion: 0.05
Nodes (76): main(), main(), int8_t, uint16_t, uint32_t, uint64_t, uint8_t, Metadata (+68 more)
...
### Community 384 - "M12GdnChunkWorkspace"
Cohesion: 0.18
...
### Community 409 - "half"
Cohesion: 0.14
Nodes (18): Fp16GemvMetrics, cosine_similarity, inf_detected, max_abs_error, max_relative_error, mean_abs_error, nan_detected, pass (+10 more)
...
Cohesion: 0.16
Nodes (31): close(), cmd_chat(), cmd_config(), cmd_doctor(), cmd_inspect(), cmd_models(), cmd_run(), cmd_serve() (+23 more)
...
### Community 539 - "UpdateProvenance"
Cohesion: 0.12
...
### Community 552 - "m6a6_qwen35_full_forward.cpp"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (25): as(), T, as(), T, as(), T, string, unordered_map (+17 more)
...
Cohesion: 0.16
Nodes (21): as(), compare_outputs(), CompareMetrics, finite, max_abs, rmse, array, path (+13 more)
...
Cohesion: 0.12
Nodes (26): tensor, RuntimeState, path, uint32_t, vector, main(), run_combined(), main() (+18 more)
...
### Community 600 - "model_loader_test.cpp"
Cohesion: 0.32
...
### Community 604 - "Qwen3LayerWeights"
Cohesion: 0.17
...
### Community 606 - "size_t"
Cohesion: 0.11
Nodes (29): vector, Qwen3DownProjectionContractTrace, current_s_correction, direct_signed_oracle, exact_sum_correction, Qwen3ProjectionProbeTrace, output, Qwen3Projection (+21 more)
...
Cohesion: 0.20
Nodes (9): Correctness, Decision, Diagnostic note, Environment, EXP-0314 — M25 P512 source-delta retest after stall recovery, Follow-up, Interpretation, Question (+1 more)
...
### Community 615 - "Qwen3FfnProbeTrace"
Cohesion: 0.33
...
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `kquant_wave_layout.cpp`, `.get`, `size_t`, `half`, `Qwen35RuntimeEngine`, `StageProfile`, `Qwen35Model`, `qwen35_gpu_pipeline.hpp`, `vector`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `kquant_wave_layout.cpp`, `M12GdnChunkWorkspace`, `.get`, `size_t`, `half`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `StageProfile`, `miinfer_cli.cpp`, `Qwen35Model`, `UpdateProvenance`, `qwen35_gpu_pipeline.hpp`, `vector`, `main`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `GgufTensor` connect `qwen35_gpu_pipeline.hpp` to `kquant_wave_layout.cpp`, `Qwen35TensorView`, `qwen3_gpu_primitives.hpp`, `.get`, `m24_projection_bakeoff.cpp`, `find_tensor`, `vector`, `RecurrentLayer`, `FullAttentionLayer`, `qwen3_layer_host_impl`, `run_case`, `GgufFile`, `m6a3_qwen35_layer.cpp`?**
