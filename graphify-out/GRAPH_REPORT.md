...
## Corpus Check
- 314 files · ~256,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4743 nodes · 6999 edges · 391 communities (364 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c785622`
...
## Communities (391 total, 27 thin omitted)
...
### Community 9 - "qwen3_decode_sequence_gpu_test.cpp"
Cohesion: 0.24
...
### Community 131 - ".get"
Cohesion: 0.15
Nodes (11): shared_ptr, string, Qwen35Model, artifact_path_, config_, load, model_name_, allocate() (+3 more)
...
Cohesion: 0.11
Nodes (34): AttentionKernel, capture_qwen3_head_norm(), copy_to_host(), Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, T, vector, DeviceBuffer (+26 more)
...
### Community 337 - "validate_position"
Cohesion: 0.33
...
### Community 356 - "5. Runtime Layers"
Cohesion: 0.29
...
### Community 369 - "OutputProjectionPathCapture"
Cohesion: 0.33
...
### Community 374 - "Current Project Status"
Cohesion: 0.50
...
### Community 380 - "17. Highest-Priority Research Ideas"
Cohesion: 0.40
...
### Community 382 - "array"
Cohesion: 0.15
Nodes (14): array, argmax(), size_t, span, uint32_t, is_boundary(), is_full_attention_layer(), main() (+6 more)

### Community 383 - "Metrics"
Cohesion: 0.18
Nodes (11): size_t, Metrics, actual_at_max, expected_at_max, finite, max_abs, max_index, max_rel (+3 more)

### Community 384 - "Capture"
Cohesion: 0.22
...
### Community 386 - "GemvShape"
Cohesion: 0.27
Nodes (9): GemvShape, id, k, m, projection, check_output(), vector, main() (+1 more)

### Community 387 - "EXP-0157 — M6-B65 Q4_K×Q8_1 packed-input inner loop"
Cohesion: 0.22
Nodes (8): Candidate, Correctness, Decision, Environment, EXP-0157 — M6-B65 Q4_K×Q8_1 packed-input inner loop, Interpretation, Question, Results

### Community 388 - "Q5KDeviceBlock"
Cohesion: 0.33
Nodes (6): Q5KDeviceBlock, d, dmin, qh, ql, scales

### Community 389 - "fp16_gemv_reference.cpp"
Cohesion: 0.47
Nodes (5): uint32_t, vector, evaluate_fp16_gemv(), fp16_gemv_cpu_reference(), generate_fp16_gemv_data()

### Community 390 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **2840 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2835 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `.get`, `vector`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `LayerPathCapture`, `OutputProjectionPathCapture`, `size_t`, `UpdateProvenance`, `Q8_1Block`, `RecurrentOperands`, `FullAttentionLayer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `.get`, `path_`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `validate_position`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `array`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `Capture`, `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `.get`, `qwen3_decode_sequence_gpu_test.cpp`, `run_sequence`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `m6a10_qwen35_q4k_projection.cpp`, `m6a8_qwen35_gpu_foundation.cpp`, `m6a9_qwen35_lm_head.cpp`, `span`, `m6a12_qwen35_attention_projections.cpp`, `vector`, `size_t`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `require_match`, `m6a263_qwen35_recurrent_contract.cpp`, `qwen3_layer6_external_test.cpp`, `m6a14_qwen35_state_audit.cpp`, `validate_position`, `m6a11_qwen35_attention_prefix.cpp`, `m6a3_qwen35_layer.cpp`, `recurrent_block`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`, `model_loader_test.cpp`, `array`?**
