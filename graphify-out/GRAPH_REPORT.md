...
## Corpus Check
- 442 files · ~351,407 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6141 nodes · 8542 edges · 528 communities (473 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 273 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2cf6f232`
...
## Communities (528 total, 55 thin omitted)
...
Cohesion: 0.16
Nodes (32): argmax(), capture_q8_input(), compare_checkpoint(), Q8_1Block, size_t, vector, exact_equal(), main() (+24 more)
...
### Community 123 - "main"
Cohesion: 0.17
Nodes (16): main(), detailed_compare(), detailed_device_error(), DetailedError, max_abs, mean_abs, reference_rms, relative_rms (+8 more)
...
### Community 129 - "span"
Cohesion: 0.08
Nodes (24): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), fingerprint(), first_argmax(), host_fingerprint() (+16 more)
...
Cohesion: 0.24
Nodes (19): reset, Qwen3GpuDecodeCache::reset(), attention_contract(), cache_corruption_test(), cache_slots_preserved(), checkpoints(), compare_trace(), size_t (+11 more)
...
Cohesion: 0.18
Nodes (23): Qwen3Projection, Qwen3ProjectionPrecision, capture(), copy_to_host(), size_t, span, T, uint32_t (+15 more)
...
Cohesion: 0.11
Nodes (19): GgufFile, file_descriptor_, mapping_, metadata, metadata_array_is_string, metadata_array_size, metadata_float, metadata_string (+11 more)
...
### Community 190 - ".run"
Cohesion: 0.13
Nodes (19): int16_t, Q8KDeviceBlock, bsums, d, qs, download(), download_bytes(), Q8_1Block (+11 more)
...
Cohesion: 0.12
Nodes (21): AttentionKernel, size_t, Qwen3Layer0GpuKvCache, append, keys_, snapshot_keys, snapshot_values, values_ (+13 more)
...
### Community 409 - "span"
Cohesion: 0.18
Nodes (17): span, append, reset, Qwen3DecodeCache::reset(), cache_contract_test(), checkpoint_tolerance(), checkpoints(), size_t (+9 more)
...
Cohesion: 0.07
Nodes (21): string, GemvShape, id, k, m, projection, RocblasGemmHandle, opaque (+13 more)
...
Cohesion: 0.08
Nodes (50): main(), int8_t, uint32_t, uint64_t, uint8_t, Metadata, d, dmin (+42 more)
...
### Community 490 - "Qwen3LayerWeights"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (11): as(), Buffer, p, hipEvent_t, size_t, T, Event, p (+3 more)
...
### Community 526 - "Current Project Status"
Cohesion: 0.50
Nodes (4): Completed, Completed in Task 3, Current Project Status, Not implemented

### Community 527 - "Current Scope"
Cohesion: 0.67
Nodes (3): Current Scope, In scope now, Not in scope now

## Knowledge Gaps
- **3756 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+3751 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `span`, `GatePathCapture`, `RecurrentOperands`, `KeyPathCapture`, `Qwen35RuntimeEngine`, `LayerPathCapture`, `size_t`, `qwen35_gpu_pipeline.hpp`, `UpdateProvenance`, `.run`, `RecurrentTrace`, `Qwen35Model`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `m6a3_qwen35_layer.cpp`, `path_`, `vector`, `require_tensor`, `qwen3_tokenizer.cpp`, `m6a14_qwen35_state_audit.cpp`, `run_ladder`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Qwen35Model::load`, `recurrent_block`, `gguf.cpp`, `qwen35_gpu_pipeline.hpp`, `Qwen3Model`, `Qwen35Model`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `GgufTensor` connect `qwen35_gpu_pipeline.hpp` to `require_match`, `kquant_wave_layout.cpp`, `vector`, `GgufFile`, `RecurrentLayer`, `FullAttentionLayer`, `qwen3_layer_host_impl`, `m6a3_qwen35_layer.cpp`, `Qwen35TensorView`, `.run`?**
