...
## Corpus Check
- 108 files · ~113,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1986 nodes · 2982 edges · 169 communities (154 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c86706ab`
...
2. `Qwen3GpuPlan` - 38 edges
3. `Qwen3Model` - 37 edges
4. `path_` - 30 edges
5. `GgufFile` - 28 edges
6. `qwen3_layer_host_impl()` - 27 edges
7. `M4-B — Full Qwen3 single-token forward` - 24 edges
8. `qwen3_layer_gpu_impl()` - 21 edges
9. `run_sequence()` - 20 edges
10. `fail()` - 19 edges
...
- `run_fanout()` --references--> `Q8_1Block`  [INFERRED]
  bench/q4_q8_gemv_bench.cpp → include/miinfer/q4_q8_gemv.hpp
- `fail()` --calls--> `GgufError`  [INFERRED]
  src/gguf.cpp → include/miinfer/gguf.hpp
...
### Community 16 - "M2 — Prove Specialization"
Cohesion: 0.25
Nodes (8): Core question, GO, Go / no-go decision, Goal, M2 — Prove Specialization, REASSESS, Required experimental discipline, Success criteria
...
Cohesion: 0.34
Nodes (18): vector, dequantize_q8_exact(), expand_gqa(), fp16_roundtrip(), host_swiglu(), main(), read_f32(), replay_attention_path() (+10 more)
...
### Community 109 - "Q6KDeviceBlock"
Cohesion: 0.15
Nodes (13): __half, int16_t, int8_t, uint8_t, Q6KDeviceBlock, d, qh, ql (+5 more)

### Community 110 - "Candidate research areas"
Cohesion: 0.29
Nodes (7): Candidate research areas, gfx906 primitives, Kernel configuration, Memory behavior, Quantized execution, Wave execution, Weight layout
...
### Community 121 - "path_"
Cohesion: 0.07
Nodes (61): path_, append_string(), append_u32(), append_u64(), string, uint32_t, uint64_t, uint8_t (+53 more)

### Community 122 - "run_sequence"
Cohesion: 0.07
Nodes (49): size_t, Qwen3Layer0GpuKvCache, append, keys_, reset, snapshot_keys, snapshot_values, values_ (+41 more)
...
Cohesion: 0.15
Nodes (30): allocate_shape(), __half, ostream, string, vector, escape(), free_shape(), launch_selected_gemv() (+22 more)

### Community 126 - "Current Project Status"
Cohesion: 0.50
Nodes (4): Completed, Completed in Task 3, Current Project Status, Not implemented

### Community 127 - "qwen3_layer0_gpu_test.cpp"
Cohesion: 0.26
...
### Community 132 - "Roadmap Principles"
Cohesion: 0.40
...
### Community 133 - "Qwen3FfnProbeTrace"
Cohesion: 0.16
...
Cohesion: 0.18
Nodes (28): Qwen3Projection, Qwen3ProjectionPrecision, capture(), capture_qwen3_head_norm(), copy_to_host(), __half, size_t, span (+20 more)

### Community 135 - "model_plan.cpp"
Cohesion: 0.21
Nodes (15): Q4GemvKernel, align_up(), checked_add(), byte, hipError_t, size_t, string, GpuWeightArena::allocate() (+7 more)

### Community 136 - "qwen3_layer_host_impl"
Cohesion: 0.06
Nodes (67): byte, GgufTensorType, Qwen3TensorView, source, int16_t, int8_t, uint16_t, uint8_t (+59 more)
...
### Community 139 - "Q8BoundaryDiff"
Cohesion: 0.12
Nodes (17): compare_q8_blocks(), int16_t, int8_t, uint16_t, half_bits(), Q8BoundaryDiff, different_lane_values, different_scale_blocks (+9 more)
...
### Community 141 - "fp16_gemv_reduction_diag.cpp"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (24): Acceptance target, Current evidence, Implemented slice, Independent reference, M4-B10 layer-35 Gate/Up projection isolation, M4-B11 Q8 identity and CPU accumulation contract, M4-B12 pre-FFN residual and RMSNorm isolation, M4-B13 attention RMSNorm, V, and position-zero GQA isolation (+16 more)
...
### Community 160 - "hip_check.hpp"
Cohesion: 0.27
Nodes (10): hip_check(), hip_check_failed(), hipError_t, close_enough(), T, vector, device_copy(), gpu_tests() (+2 more)

### Community 161 - "DeviceBytes"
Cohesion: 0.33
Nodes (3): DeviceBuffer, DeviceBytes, bytes_

### Community 162 - "Checkpoint"
Cohesion: 0.40
Nodes (5): Checkpoint, file, miinfer, name, tolerance

### Community 163 - "GgufError"
Cohesion: 0.44
Nodes (9): GgufError, metadata, runtime_error, string, GgufFile::metadata_array_is_string(), GgufFile::metadata_array_size(), GgufFile::metadata_float(), GgufFile::metadata_string() (+1 more)

### Community 164 - "Metrics"
Cohesion: 0.22
Nodes (9): Metrics, actual_at_max, expected_at_max, finite, max_abs, max_index, max_rel, mean_abs (+1 more)

### Community 165 - "AttentionPathReplay"
Cohesion: 0.33
Nodes (6): AttentionPathReplay, attention_output, ffn_input, ffn_norm, layer_output, v

### Community 166 - "FfnTailReplay"
Cohesion: 0.33
Nodes (6): FfnTailReplay, down, gate, layer_output, swiglu, up

### Community 167 - "replay_projection"
Cohesion: 0.70
Nodes (5): AccumulationContract, size_t, replay_projection(), replay_projection_row(), report_host_projection_contracts()

### Community 168 - "Checkpoint"
Cohesion: 0.40
Nodes (5): Checkpoint, file, miinfer, name, tolerance

## Knowledge Gaps
- **1138 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+1133 more)
...
- **Why does `GgufFile` connect `GgufFile` to `GgufError`, `vector`, `Qwen3Model`, `require_tensor`, `gguf.cpp`, `path_`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `Qwen3LayerWeights`, `model_plan.cpp`, `qwen3_layer_host_impl`, `Qwen3GpuPlan`, `replay_projection`, `require_tensor`, `GgufFile`, `qwen3_layer35_external_test.cpp`, `RmsVariant`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Qwen3LayerTrace` connect `Qwen3LayerTrace` to `qwen3_gpu_layer.cpp`, `replay_projection`, `qwen3_layer_host_impl`, `path_`, `run_sequence`, `qwen3_layer35_external_test.cpp`, `qwen3_layer6_external_test.cpp`, `qwen3_layer0_gpu_test.cpp`?**
