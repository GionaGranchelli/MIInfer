...
revision metadata. The complete snapshot was downloaded on 2026-08-29.
...
Conversion completed on 2026-08-29 with the command above using the converter
at the pinned reference commit. The artifact is
...
ROCm model buffer, and completed single-turn generation with exit status 0.
The retained log is
`/home/fedora-workstation/Development/mi50-artifacts/qwen3-8b-reference-smoke-single-turn-20260829.log`.
