...
## Corpus Check
- 278 files · ~241,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4375 nodes · 6627 edges · 350 communities (323 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70ab1983`
...
### Community 50 - "main"
Cohesion: 0.22
Nodes (9): allocate(), GgufTensorType, initializer_list, main(), require_type(), end, top_indices(), upload() (+1 more)
...
Cohesion: 0.21
Nodes (7): size_t, string, DeviceBytes, bytes_, data_, RecurrentTrace, position
...
Cohesion: 0.12
Nodes (27): ByteMismatch, count, first, compare_bytes(), cosine_similarity(), byte, span, uint64_t (+19 more)
...
Cohesion: 0.26
Nodes (12): Buffer, uint32_t, GpuLayerRef, attention, recurrent, project(), project_q4_q8_1(), project_q4_q8_1_prequantized() (+4 more)
...
### Community 297 - "qwen3_generate.cpp"
Cohesion: 0.13
...
### Community 333 - "qwen3_gpu_primitives.hpp"
Cohesion: 0.18
...
## Knowledge Gaps
- **2555 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2550 more)
...
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `validate_position`, `recurrent_inputs`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`, `path_`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `size_t`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `uint32_t`, `main`, `LayerPathCapture`, `RecurrentOperands`, `Qwen35Config`, `vector`, `OutputProjectionPathCapture`, `StageProfile`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `model_plan.cpp`, `print_text`, `qwen3_decode_sequence_gpu_test.cpp`, `Qwen3GpuPlan`, `Qwen3Layer0KvCache`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `Qwen3Config`, `gguf.cpp`, `vector`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
