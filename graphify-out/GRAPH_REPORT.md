...
## Corpus Check
- 638 files · ~717,615 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7019 nodes · 9632 edges · 581 communities (523 shown, 58 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 298 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `774b5a4a`
...
## Communities (581 total, 58 thin omitted)
...
### Community 41 - "Qwen3Layer0GpuKvCache"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (62): GgufTensor, byte_size, data, dimensions, name, offset, type, GgufTensorType (+54 more)
...
### Community 143 - "kquant_wave_layout.cpp"
Cohesion: 0.21
...
Cohesion: 0.26
Nodes (10): vector, main(), measure(), Stats, mean_us, median_us, summarize(), hip_check() (+2 more)
...
Cohesion: 0.15
Nodes (38): main(), upload(), check_values(), span, main(), checkpoint(), compare(), conv_output() (+30 more)
...
Cohesion: 0.10
Nodes (12): as(), Buffer, p, hipEvent_t, size_t, T, Event, p (+4 more)
...
### Community 456 - "q4_q8_gemv.hpp"
Cohesion: 0.09
Nodes (22): GemvKernelResources, local_bytes, max_threads_per_block, registers, shared_bytes, GemvShape, id, k (+14 more)
...
Cohesion: 0.05
Nodes (42): B128 convolution contract, Baseline, Candidate — B128 attention Q/K/V projection — 2026-09-10, Candidate — batched causal attention launch — 2026-09-10, Candidate — cached Q8_1 affine sum — 2026-09-10, Candidate — gfx906 affine MMQ launch bounds — 2026-09-10, Candidate — gfx906 Q6 MMQ launch bounds — 2026-09-10, Candidate — MMQ activation-scale hoist — 2026-09-10 (+34 more)
...
## Knowledge Gaps
- **4301 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+4296 more)
...
- **Why does `FullAttentionLayer` connect `FullAttentionLayer` to `size_t`, `StageProfile`, `vector`, `Qwen35RuntimeEngine`, `Qwen35Model`, `Metadata`, `qwen35_gpu_pipeline.hpp`, `uint32_t`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `M12GdnChunkWorkspace`, `size_t`, `UpdateProvenance`, `q4_q8_gemv.hpp`, `vector`, `StageProfile`, `Qwen35RuntimeEngine`, `FullAttentionLayer`, `Qwen35Model`, `miinfer_cli.cpp`, `Metadata`, `qwen3_gpu_primitives.hpp`, `qwen35_gpu_pipeline.hpp`, `uint32_t`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Qwen35RuntimeEngine` connect `Qwen35RuntimeEngine` to `M12GdnChunkWorkspace`, `size_t`, `.generate`, `q4_q8_gemv.hpp`, `StepResult`, `qwen3_tokenizer.cpp`, `RuntimeGenerateStats`, `RecurrentLayer`, `FullAttentionLayer`, `Qwen35Model`, `miinfer_cli.cpp`, `PrefillProfile`, `qwen35_gpu_pipeline.hpp`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **What connects `experiment`, `shape`, `implementation` to the rest of the system?**
  _4301 weakly-connected nodes found - possible documentation gaps or missing edges._
