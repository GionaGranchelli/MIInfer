...
## Corpus Check
- 319 files · ~257,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4778 nodes · 7029 edges · 387 communities (360 shown, 27 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3cfea395`
...
### Community 122 - "qwen3_decode_profile.cpp"
Cohesion: 0.18
...
### Community 129 - "GgufTensor"
Cohesion: 0.13
Nodes (15): GgufTensor, byte_size, data, dimensions, name, offset, type, byte (+7 more)
...
Cohesion: 0.11
Nodes (18): vector, main(), measure(), Stats, mean_us, median_us, summarize(), RocblasGemmHandle (+10 more)
...
Cohesion: 0.08
Nodes (33): Function, hipEvent_t, Qwen3BoundaryProfileStage, Qwen3FfnProfileStage, Qwen3ProfileCategory, launch_projection(), profile_copy_call(), profile_gpu_call() (+25 more)
...
### Community 308 - "qwen3_gpu_layer.hpp"
Cohesion: 0.22
...
### Community 362 - "GemvKernelResources"
Cohesion: 0.33
...
Cohesion: 0.18
Nodes (16): validate_cache(), Qwen3GpuDecodeCache, caches_, length, prepare, workspace_, uint32_t, device_f32_tensor() (+8 more)
...
## Knowledge Gaps
- **2865 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2860 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `GgufTensor`, `GatePathCapture`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `LayerPathCapture`, `UpdateProvenance`, `size_t`, `RecurrentOperands`, `Qwen35Config`, `FullAttentionLayer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `GgufTensor`, `m6a15_qwen35_hybrid_block_audit.cpp`, `path_`, `vector`, `validate_position`, `m6a14_qwen35_state_audit.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `array`, `Qwen35Config`, `m6a3_qwen35_layer.cpp`, `run_combined`, `Qwen3Model`, `run_ladder`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `path_` connect `path_` to `GgufTensor`, `qwen3_trace_compare.cpp`, `m6a13_qwen35_full_attention_layer.cpp`, `m6a15_qwen35_hybrid_block_audit.cpp`, `run_sequence`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `Metrics`, `m6a10_qwen35_q4k_projection.cpp`, `m6a8_qwen35_gpu_foundation.cpp`, `GgufFile`, `m6a9_qwen35_lm_head.cpp`, `span`, `m6a12_qwen35_attention_projections.cpp`, `validate_position`, `size_t`, `qwen3_layer35_external_test.cpp`, `qwen3_forward_gpu_test.cpp`, `require_match`, `m6a263_qwen35_recurrent_contract.cpp`, `metrics`, `m6a14_qwen35_state_audit.cpp`, `m6a11_qwen35_attention_prefix.cpp`, `qwen3_decode_sequence_gpu_test.cpp`, `m6a3_qwen35_layer.cpp`, `array`, `m6a1_reference_fixture.cpp`, `qwen3_layer0_gpu_test.cpp`, `run_combined`, `model_loader_test.cpp`, `run_ladder`?**
