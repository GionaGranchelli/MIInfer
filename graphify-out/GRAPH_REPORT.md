...
## Corpus Check
- 307 files · ~253,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4668 nodes · 6916 edges · 379 communities (351 shown, 28 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c0aaddd`
...
1. `RecurrentLayer` - 101 edges
2. `path_` - 78 edges
3. `FullAttentionLayer` - 62 edges
...
## Communities (379 total, 28 thin omitted)
...
### Community 50 - "size_t"
Cohesion: 0.19
Nodes (12): Buffer, size_t, string, uint32_t, project(), project_q4_q8_1(), project_q4_q8_1_prequantized(), project_q5_q8_1() (+4 more)
...
Cohesion: 0.03
Nodes (72): RecurrentLayer, alpha_raw, beta, beta_raw, d_a, d_alpha, d_attn_norm, d_beta (+64 more)
...
### Community 166 - "qwen3_gpu_layer.hpp"
Cohesion: 0.15
...
### Community 168 - ".get"
Cohesion: 0.18
Nodes (7): allocate(), DeviceBytes, bytes_, data_, replay_state(), upload(), upload_tensor()
...
Cohesion: 0.04
Nodes (47): FullAttentionLayer, attention, batch_head_rms, d_attn_norm, d_ffn_down, d_ffn_gate, d_ffn_up, d_k (+39 more)
...
Cohesion: 0.12
Nodes (40): AttentionKernel, Qwen3Projection, Qwen3ProjectionPrecision, capture(), copy_to_host(), size_t, span, T (+32 more)
...
### Community 308 - "Qwen3LayerWeights"
Cohesion: 0.17
...
Cohesion: 0.10
Nodes (21): vector, download(), KeyPathCapture, input, key, key_norm, normalized, qkv (+13 more)
...
### Community 354 - "Qwen3GpuDecodeCache"
Cohesion: 0.25
...
### Community 368 - "HostQ8Block"
Cohesion: 0.33
Nodes (6): int8_t, uint16_t, HostQ8Block, d_bits, qs, s_bits

### Community 369 - "qwen3_swiglu_q8_bench.cpp"
Cohesion: 0.39
...
### Community 376 - "Qwen3ForwardTrace"
Cohesion: 0.40
...
### Community 379 - "StageProfile"
Cohesion: 0.50
Nodes (4): array, hipEvent_t, StageProfile, start

## Knowledge Gaps
- **2782 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+2777 more)
...
- **Why does `RecurrentLayer` connect `RecurrentLayer` to `.get`, `m6a21_qwen35_gpu_hybrid_block.cpp`, `UpdateProvenance`, `LayerPathCapture`, `size_t`, `GatePathCapture`, `RecurrentOperands`, `Qwen35Config`, `vector`, `StageProfile`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `vector` to `Qwen35Config`, `m6a15_qwen35_hybrid_block_audit.cpp`, `path_`, `m6a18_qwen35_deltanet_state_gpu.cpp`, `recurrent_block`, `gguf.cpp`, `m6a3_qwen35_layer.cpp`, `Qwen3Model`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_fast_decode_bench.cpp`, `qwen3_inference_bench.cpp`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_decode_profile.cpp`, `qwen3_layer_host_impl`, `Qwen3LayerWeights`, `gguf.cpp`, `vector`, `model_plan.cpp`, `qwen3_layer35_external_test.cpp`?**
