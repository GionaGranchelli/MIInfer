...
## Corpus Check
- 139 files · ~139,464 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2497 nodes · 3977 edges · 201 communities (179 shown, 22 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c943ad49`
...
Cohesion: 0.25
Nodes (7): Benchmarks, End-to-end M5-A baseline, M5-B steady-state decode profile, M5-C0 trace-free decode benchmark, M5-C1 position-scaled execution audit, M5-C2 cooperative cached attention, M5-C3 interleaved attention A/B benchmark
...
Cohesion: 0.10
Nodes (43): validate_cache(), Qwen3GpuDecodeCache, caches_, length, reset, reset, Qwen3ForwardTrace, embedding (+35 more)
...
### Community 121 - "path_"
Cohesion: 0.09
Nodes (54): path_, argmax(), capture_q8_input(), compare_checkpoint(), size_t, vector, exact_equal(), main() (+46 more)
...
Cohesion: 0.24
Nodes (11): size_t, Qwen3Layer0GpuKvCache, append, keys_, snapshot_keys, snapshot_values, values_, execute_qwen3_decode_gpu() (+3 more)
...
Cohesion: 0.14
Nodes (23): Qwen3Projection, Qwen3ProjectionPrecision, capture(), copy_to_host(), __half, size_t, span, T (+15 more)
...
### Community 165 - "qwen3_gpu_layer.cpp"
Cohesion: 0.19
Nodes (11): reset, capture_qwen3_head_norm(), uint32_t, execute_qwen3_forward_gpu(), execute_qwen3_layer0_gpu(), launch_projection(), projection_profile_category(), projection_selected() (+3 more)
...
### Community 189 - "model_loader_test.cpp"
Cohesion: 0.35
...
## Knowledge Gaps
- **1348 isolated node(s):** `experiment`, `shape`, `implementation`, `cache_regime`, `custom_label` (+1343 more)
...
- **Why does `Qwen3Model` connect `Qwen3Model` to `qwen3_decode_profile.cpp`, `qwen3_fast_decode_bench.cpp`, `Qwen3LayerWeights`, `model_plan.cpp`, `Qwen3GpuPlan`, `qwen3_tokenizer.cpp`, `qwen3_layer_host_impl`, `GgufFile`, `gguf.cpp`, `Qwen3Config`, `qwen3_inference_bench.cpp`, `replay_projection`, `Qwen3TensorView`, `qwen3_layer35_external_test.cpp`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Qwen3GpuPlan` connect `Qwen3GpuPlan` to `qwen3_decode_profile.cpp`, `qwen3_layer_gpu_impl`, `qwen3_fast_decode_bench.cpp`, `qwen3_gpu_layer.cpp`, `size_t`, `model_plan.cpp`, `qwen3_attention_ab_bench.cpp`, `qwen3_layer6_external_test.cpp`, `Qwen3Model`, `DeviceInfo`, `path_`, `qwen3_inference_bench.cpp`, `qwen3_layer35_external_test.cpp`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GgufFile` connect `GgufFile` to `GgufTensor`, `Qwen3Model`, `gguf.cpp`, `path_`, `vector`?**
